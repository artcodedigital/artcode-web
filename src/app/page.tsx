...
const Home = () => {
  return (
    <div className="max-w-[1500px] min-h-[calc(100dvh-96px)] w-[95%] m-auto text-center flex flex-col items-center justify-between">
      <div className="w-full md:w-fit absolute bottom-0 left-1/2 transform -translate-x-1/2 border-[7px] border-b-0 border-gray-100 rounded-t-full p-7 pb-0">
        <div className="w-full md:w-fit border-[7px] border-b-0 border-gray-100 rounded-t-full p-7 pb-0">
          ...
          <div>
            <Image
              className="absolute top-[-10.1%] lg:top-[-36%] md:top-[-37%] left-1/2 transform -translate-x-1/2 z-10 w-[388px] h-[400px] lg:w-[388px] lg:h-[494px] md:h-[500px]"
      ...
      <div className="flex flex-col items-center space-y-6 p-5">
        ...
        <div className="flex items-center justify-center gap-2">
          <h2 className="font-medium lg:text-xl text-lg relative w-fit m-auto">
            ...
            integrado com {''}
            <motion.span
              className="text-transparent bg-clip-text leading-[1.3]"
              style={{
                backgroundImage:
              ...
              <Image
                className="absolute w-6 lg:w-7 right-14 lg:right-9 bottom-0.5 lg:bottom-0 md:right-9"
